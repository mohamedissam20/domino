...
class EditPage2 extends StatelessWidget {
  ...
  const EditPage2({super.key, required this.index, required this.image});
                    ...
                    builder:(context)=> Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: MaterialButton(
                            ...
                            onPressed:() {
                              cubit.addPlayer2PhotoToDatabase( base64string , index ,context);
                            },
                            child: Padding(
                              padding: const EdgeInsetsDirectional.only(
                                  top: 2,
                    ...
                    Expanded(
                      child: SizedBox(
                        ...
                        child: Padding(
                            ...
                            child: image == '' ?
                            croppedPlayer2Image != null ?
                            Image (image : FileImage(croppedPlayer2Image!))
                                :
                            SizedBox()
                                :
                            croppedPlayer2Image != null ?
                                          ...
                                          builder: (context, setState) =>
                                              AlertDialog(
                                                ...
                                                actions: [
                                                  ...
                                                  TextButton(
                                                    onPressed: () {
                                                      cubit.addPlayer2PhotoToDatabase('',index,context);
                                                      Navigator.pop(
                                                          context); // Close the dialog
                                                    },
                                                    child: Text('Yes',style: Theme.of(context).textTheme.bodyLarge!.copyWith(
